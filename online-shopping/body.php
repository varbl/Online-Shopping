			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=32"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop1.png" alt="">
							</div>
							<div class="shop-body">
								<h3>Summer<br>Coctail</h3>
								<a href="product.php?p=32" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<!-- shop -->
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=33"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop2.png" alt="">
							</div>
							<div class="shop-body">
								<h3>Lazy Day<br>Fest</h3>
								<a href="product.php?p=33" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<!-- shop -->
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=34"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop3.png" alt="">
							</div>
							<div class="shop-body">
								<h3>Ombre<br>Sun</h3>
								<a href="product.php?p=34" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Beauty</a></li>
									<li><a data-toggle="tab" href="#tab1">Accessories</a></li>
									<li><a data-toggle="tab" href="#tab1">Ladies Wears</a></li>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab2">Home</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/product006.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/product007.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/product008.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/product009.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
